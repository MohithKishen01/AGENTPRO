...
function getInitParam_106510309 ()
{
    var xmlText = "<Dataset>";
...
function getBetTypeListParam_106510309 ()
{
	var xmlText = "<DataSet>";
	xmlText += UDModule.PROJ.getProcessXML (kMainBetTypes);
	xmlText += getCommonListXML_106510309 ();
	xmlText += "</DataSet>";

	return xmlText;
}

function getLeagueListParam_106510309 ()
{
	var xmlText = "<DataSet>";
...
function getBookieListParam_106510309 ()
{
    var xmlText = "<Dataset>";
...
function getCommonListXML_106510309 ()
{
    var xmlText = "<" + kCR_CommonList + "><id>";
	xmlText += UDModule.DATE.getSQLDate (getFromDate_106510309 ()) + UDModule.Gk_DATA_SEP;
	xmlText += UDModule.DATE.getSQLDate (getToDate_106510309 ()) + UDModule.Gk_DATA_SEP;
	xmlText += getCompanyUnitId_106510309 ();
    xmlText += "</id></" + kCR_CommonList + ">";

    return xmlText;
}

function getBookiePerformanceParam_106510309 ()
{
    var xmlText = "<Dataset>";
    xmlText += UDModule.PROJ.getProcessXML (kBookiePerformance);
    xmlText += getBookiePerformanceXML_106510309 ();
    xmlText += "</Dataset>";

    return xmlText;
}

function getBookiePerformanceXML_106510309 ()
{
	var arrBookieIds = getSelectedIds_BO_106510309 ();
    var oBookieIds = arrBookieIds.length > 0 ? arrBookieIds.join (",") : "0";
    
    var arrLeagueIds = getSelectedIds_LL_106510309 ();
    var oLeagueIds = arrLeagueIds.length > 0 ? arrLeagueIds.join (",") : "-1";
    
    var arrBetTypeIds = getSelectedIds_BT_106510309 ();
    ...
    xmlText += getWinLoseTypeId_106510309 () + UDModule.Gk_DATA_SEP;	
	xmlText += UDModule.DATE.getSQLDate (getFromDate_106510309 ()) + UDModule.Gk_DATA_SEP;
	xmlText += UDModule.DATE.getSQLDate (getToDate_106510309 ()) + UDModule.Gk_DATA_SEP;	
	xmlText += oBookieIds + UDModule.Gk_DATA_SEP;
	xmlText += oLeagueIds + UDModule.Gk_DATA_SEP;
	xmlText += oBetTypeIds + UDModule.Gk_DATA_SEP;
	xmlText += getPtBetsOptionId_106510309 () + UDModule.Gk_DATA_SEP;
	xmlText += getLiveStatusId_106510309 () + UDModule.Gk_DATA_SEP;
    xmlText += getCurrencyId_106510309 () + UDModule.Gk_DATA_SEP;
	xmlText += getCompanyUnitId_106510309 ();	
...
function getAccountPerformanceParam_106510309 ()
{
    var xmlText = "<Dataset>";
    xmlText += UDModule.PROJ.getProcessXML (kAccountPerformance);
    xmlText += getAccountPerformanceXML_106510309 ();
    xmlText += "</Dataset>";

    return xmlText;
}

function getAccountPerformanceXML_106510309 ()
{
	var arrBookieIds = getSelectedIds_BO_106510309 ();
    var oBookieIds = arrBookieIds.length > 0 ? arrBookieIds.join (",") : "0";
...
function getLeaguePerformanceParam_106510309 ()
{
    var xmlText = "<Dataset>";
    xmlText += UDModule.PROJ.getProcessXML (kLeaguePerformance);
    xmlText += getLeaguePerformanceXML_106510309 ();
    xmlText += "</Dataset>";

    return xmlText;
}

function getLeaguePerformanceXML_106510309 ()
{
	var arrBookieIds = getSelectedIds_BO_106510309 ();
    var oBookieIds = arrBookieIds.length > 0 ? arrBookieIds.join (",") : "0";
