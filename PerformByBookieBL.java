package enlj.p106trading.mssqlv51.p10651soccer.psperformbybookie.logics;
...
{
    /* Module Id */
    private final String kModuleId = "106510309";    	
    	
	/* Task Ids */
	private final String kInitData				= "10651030901";	
	private final String kMainBetTypes			= "10651030904";
	private final String kLeagues				= "10651030905";
	private final String kBookies				= "10651030906";
	private final String kBookiePerformance		= "10651030907";
	private final String kAccountPerformance	= "10651030908";
	private final String kLeaguePerformance		= "10651030909";

	private final String kA_LeaguePerfByBookie	= "10651030911";
	private final String kB_BookiePerfByLeague	= "10651030921";
    ...
    private final int f_CompanyUnitId	= 2;
    ...
    */   
	...
	private String getMainBetTypes ()
    {
        ...
        {			
			...
			String oSQL =
				...
				" From en_0651c02_betinfo_soc, en_0251z00_bettype_main, en_0251b02_accountinfo, en_0251z00_bettype " +
				" Where en_0651c02_betinfo_soc.bettypeid = en_0251z00_bettype.bettypeid And " +
					" en_0651c02_betinfo_soc.accountid = en_0251b02_accountinfo.accountid And " +
	                " en_0251b02_accountinfo.unitid = " + arrInfo [f_CompanyUnitId] + " And " +
					" en_0251z00_bettype_main.mainbettypeid = en_0251z00_bettype.mainbettypeid And " +
					" en_0651c02_betinfo_soc.settlementdate Between '" + oFromDate + "' And '" + oToDate + "' And " +
					" en_0251z00_bettype.sportid = " + SportUtil.kS_Soccer +
	...
	private String getLeagueList ()
    {
        ...
        {		
			...
			String oSQL =
				" Select Distinct en_0651c02_betinfo_soc.leagueid, " +
					" en_0651b01_leagueinfo_soc.leaguename_" + getLanguage () + " As leaguename " +
				" From en_0651c02_betinfo_soc, en_0251b02_accountinfo, en_0651b01_leagueinfo_soc " +
				" Where en_0651c02_betinfo_soc.leagueid = en_0651b01_leagueinfo_soc.leagueid And " +
					" en_0651c02_betinfo_soc.accountid = en_0251b02_accountinfo.accountid And " +
	                " en_0251b02_accountinfo.unitid = " + arrInfo [f_CompanyUnitId] + " And " +
					" en_0651c02_betinfo_soc.settlementdate Between '" + oFromDate + "' And '" + oToDate + "' And " +
					" en_0651b01_leagueinfo_soc.leagueid > 0 " +
				" Order By leaguename ";
	...
	private String getBookieList ()
    {
        ...
        try
		{
			...
			String oFromDate = arrInfo [f_FromDate_CL] + " 00:00:00";
			String oToDate = arrInfo [f_ToDate_CL] + " 23:59:59";
			int nUnitId = convertToInt (arrInfo [f_CompanyUnitId]);
			...
			String oSQL =
				...
				" From en_0251b02_accountinfo, en_0651c02_betinfo_soc, en_0251b01_bookieinfo " +
				" Where en_0251b02_accountinfo.accountid = en_0651c02_betinfo_soc.accountid And " + 					
	...
	private String getBookiePerformance ()
    {
        ...
        String oXMLString = oLogic.getBookiePerformance (SportUtil.kS_Soccer, arrInfo);
        return oXMLString;
	}
	...
	private String getAccountPerformance ()
    {
        ...
        String oXMLString = oLogic.getAccountPerformance (SportUtil.kS_Soccer, arrInfo);
        return oXMLString;
	}
	...
	private String getLeaguePerformance ()
    {
        ...
        String oXMLString = oLogic.getLeaguePerformance (SportUtil.kS_Soccer, arrInfo);
        return oXMLString;
	}
	...
	private String getLeaguePerform_A ()
    {
		...
		for (int nIndex = 0; nIndex < arrNodes.getLength (); nIndex++)
		{
	        ...
	        oBuffer.append (oLogic.getLeaguePerfBookie (SportUtil.kS_Soccer, arrInfo));
		}
