...
function buildCommonListUI_BT_106510309 ()
{	
	...
	if (m_arrNodes_BT.length > 0)
	{
		...
		objCommon.kEM_NameClicked		    = "lblClicked_BT_106510309";
		objCommon.kEM_SelectAllClicked	    = "lblSelectAllClicked_BT_106510309 ()";
		objCommon.kEM_ClearAllClicked	    = "lblClearAllClicked_BT_106510309 ()";
		objCommon.kEM_CloseClicked		    = "closeClicked_BT_106510309 ()";
		objCommon.kEM_SetSelectionClicked	= "setSelectionClicked_BT_106510309 ()";
		
		UDModule.COMP.replaceDynamicHtml ("tdBetTypeList", objCommon.buildCommonListUI (objCommon));
	}
	else
		UDModule.COMP.replaceDynamicHtml ("tdBetTypeList", UDModule.TBL.getNoDataPresentEx (987, 100, 1, ""));
}

function storeSelectedIds_BT_106510309 ()
{
...
function getSelectedIds_BT_106510309 ()
{
    return m_arrSelectedIds_BT;
}

function setCommonList_BT_106510309 (arrNodes)
{
	m_arrNodes_BT = arrNodes;
}

function lblShowClicked_BT_106510309 ()
{
	if (isValidDate_106510309 ())
	{
		...
		showBetTypeClicked_BT_106510309 ();
		buildCommonListUI_BT_106510309 ();			
	}
}

function showBetTypeClicked_BT_106510309 ()
{
	var xmlDoc = UDModule.PROJ.processRequest (getBetTypeListParam_106510309 ());
	if (UDModule.PROJ.isValidStatus (xmlDoc))    
	{
		if (isValidStatus_T4_106510309 (xmlDoc))
		{                   			                 	        
			var nodeList = xmlDoc.getElementsByTagName (kSR_MainBetTypes);
			var arrNodes = UDModule.DOM.convertNodesToArray (nodeList);
			setCommonList_BT_106510309 (arrNodes);
		}
	}
}

function lblHideClicked_BT_106510309 ()
{
	UDModule.COMP.setDisplay ("trPerformanceList", "block");
    toggleView_BT_106510309 (); 
}

function lblClicked_BT_106510309 (nBetTypeId)
{
    var oElement = UDModule.COMP.getElement (kE_ChkElement_BT + nBetTypeId);	
	if (oElement != null)	
...
function lblSelectAllClicked_BT_106510309 ()
{
    for (var nIndex = 0; nIndex < m_arrNodes_BT.length; nIndex++)
	{
		var arrInfo = m_arrNodes_BT [nIndex];
...
function lblClearAllClicked_BT_106510309 ()
{
    for (var nIndex = 0; nIndex < m_arrNodes_BT.length; nIndex++)
	{
		var arrInfo = m_arrNodes_BT [nIndex];
...
function closeClicked_BT_106510309 ()
{
	UDModule.COMP.setDisplay ("trPerformanceList", "block");
...
function setSelectionClicked_BT_106510309 ()
{
    storeSelectedIds_BT_106510309 ();
    toggleView_BT_106510309 ();
}

function clearValues_BT_106510309 ()
{
	m_arrSelectedIds_BT = new Array ();
	toggleView_BT_106510309 ();
}

function toggleView_BT_106510309 ()
{
    UDModule.COMP.setDisplay ("tdShowBetTypes", "block");
	UDModule.COMP.setDisplay ("tdHideBetTypes", "none");	
