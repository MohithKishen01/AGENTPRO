...
function getInitParam_106510309a ()
{
	var xmlText = "<DataSet>";
	xmlText += UDModule.PROJ.getProcessXML (kA_LeaguePerfByBookie);
	xmlText += getLeagueListXML_106510309a ();
	xmlText += "</DataSet>";

	return xmlText;
}

function getLeagueListXML_106510309a ()
{
    ...
    xmlText += getFilterValue_106510309a (kFT_BookieId) + UDModule.Gk_EXT_SEP;
	xmlText += getFilterValue_106510309a (kFT_FromDate) + UDModule.Gk_EXT_SEP;
	xmlText += getFilterValue_106510309a (kFT_ToDate) + UDModule.Gk_EXT_SEP;
	xmlText += m_oLeagueIds + UDModule.Gk_EXT_SEP;
	xmlText += m_oBetTypeIds + UDModule.Gk_EXT_SEP;
	xmlText += getFilterValue_106510309a (kFT_WinLoseTypeId) + UDModule.Gk_EXT_SEP;
	xmlText += getFilterValue_106510309a (kFT_LiveStatusId) + UDModule.Gk_EXT_SEP;
	xmlText += getFilterValue_106510309a (kFT_PTBetsId) + UDModule.Gk_EXT_SEP;
	xmlText += getFilterValue_106510309a (kFT_CurrencyId) + UDModule.Gk_EXT_SEP;
	xmlText += getFilterValue_106510309a (kFT_CompanyUnitId);
    xmlText += "</id>";
